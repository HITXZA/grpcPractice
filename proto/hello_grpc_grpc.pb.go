...
type HelloGRPCClient interface {
	...
	SayHello(ctx context.Context, in *Req2, opts ...grpc.CallOption) (*Res2, error)
}
...
func (c *helloGRPCClient) SayHello(ctx context.Context, in *Req2, opts ...grpc.CallOption) (*Res2, error) {
	out := new(Res2)
...
type HelloGRPCServer interface {
	...
	SayHello(context.Context, *Req2) (*Res2, error)
...
func (UnimplementedHelloGRPCServer) SayHello(context.Context, *Req2) (*Res2, error) {
...
func _HelloGRPC_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloGRPCServer).SayHello(ctx, req.(*Req2))
	}
	return interceptor(ctx, in, info, handler)
}
